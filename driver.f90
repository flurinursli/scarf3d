PROGRAM DRIVER
  ...
  ! CORRELATION LENGTH
  CL = [5000._FPP, 5000._FPP, 5000._FPP] / 5._FPP
  ...
  CALL SCARF3D_SPEC(DR, FS, FE, ACF, CL, SIGMA, HURST, SEED, POI, MUTE, TAPERING, RESCALE, V3, INFO(1:6))
  !CALL SCARF3D_SPEC(X1, Y1, Z1, DR, ACF, CL, SIGMA, HURST, SEED, POI, MUTE, TAPERING, RESCALE, V1, INFO(1:6))
  ...
  CALL SCARF3D_WRITE_SLICE(1, 32, V3, 'spec_xslice')
  CALL SCARF3D_WRITE_SLICE(2, 32, V3, 'spec_yslice')
  CALL SCARF3D_WRITE_SLICE(3, 32, V3, 'spec_zslice')
  ...
  ! WRITE A MODEL SLICE TO DISK
  CALL SCARF3D_WRITE_SLICE(1, 32, V3, 'fft_xslice')
  CALL SCARF3D_WRITE_SLICE(2, 32, V3, 'fft_yslice')
  CALL SCARF3D_WRITE_SLICE(3, 32, V3, 'fft_zslice')
