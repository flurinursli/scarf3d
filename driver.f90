PROGRAM DRIVER
  ...
  ! CORRELATION LENGTH
  CL = [5000._FPP, 5000._FPP, 5000._FPP] / 10._FPP
  ...
  CALL SCARF3D_SPEC(X1, Y1, Z1, DH, ACF, CL, SIGMA, HURST, SEED, POI, MUTE, TAPERING, V1, INFO(1:2))
  ...
  ! SOME TIMING INFO
  IF (RANK .EQ. 0) THEN
    PRINT*, 'TIMING CPU: ', REAL(INFO(1), KIND=REAL32)
    PRINT*, 'TIMING GPU: ', REAL(INFO(2), KIND=REAL32)
  ENDIF
