PROGRAM DRIVER
  ...
  CALL SCARF_INITIALIZE(FS, FE, DS, ACF, CL, SIGMA, METHOD = 0, HURST = HURST, PAD = 1)
  ...
  CALL SCARF_IO(N, 1, 400, V3, 'fft_struct_xslice')
  CALL SCARF_IO(N, 2, 250, V3, 'fft_struct_yslice')
  CALL SCARF_IO(N, 3, 100, V3, 'fft_struct_zslice')
  ...
  CALL SCARF_INITIALIZE(X1, Y1, Z1, DH, ACF, CL, SIGMA, METHOD = 0, HURST = HURST, PAD = 1)
  ...
  CALL SCARF_IO(N, 1, 400, V3, 'spec_struct_xslice')
  CALL SCARF_IO(N, 2, 250, V3, 'spec_struct_yslice')
  CALL SCARF_IO(N, 3, 100, V3, 'spec_struct_zslice')
